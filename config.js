...
global.devs = '94779122081';
global.website = 'https://github.com/prabathLK/PRABATH-MD' //+94779122081
...
module.exports = {
  ...
  botname: process.env.BOT_NAME || 'NR RASHU MODZ',
  ...
  alivemsj: process.env.ALIVE_MSJ || '*POWERD BY RASHU MODZ* 🎊',
  ownername:process.env.OWNER_NAME || 'NR RASHU',
